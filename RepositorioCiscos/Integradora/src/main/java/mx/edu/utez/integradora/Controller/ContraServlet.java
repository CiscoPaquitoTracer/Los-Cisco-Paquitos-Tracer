            ...
            if (dao.insertCod(rands,correo)){
                ...
                try {
                    ...
                    mail.sendMail(correo,"Recuperación de contraseña","<H1>HOLA "+u.getNombre_usuario()+"</H1>"+
                            ...
                            "<CENTER>"+rands+"</CENTER>"+
                            "<a href=http://localhost:8080/practica3E_war_exploded/recuContra?codigo="+rands+">RECUPERAR MI CONTRASEÑA</a>"
                    );
                    sesion.setAttribute("mensaje","Se ha enviado un correo electrónico de verificación");
                } catch (Exception e) {
