        ...
        <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
            ...
            <div class="col-md-3 text-end">
                <div class="dropstart" id="w">
                    ...
                    <label class="fs-4" id="UserData">¡Bienvenido!</label>
                    <a href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <img src="IMG/UserI.png" id="perfil" width="45" height="45" alt="Perfil">
                    </a>
                    <ul class="dropdown-menu dropdown-menu-dark">
                        <li><center><img src="IMG/UserI.png" id="perfil2" width="35" height="35" alt="PerfilChiquito"></center></li>
                        <li><center><label>¡Hola, <strong id="name"><%=name%></strong>!</label></center></li>
                        <li><hr class="dropdown-divider"></li>
                        <li><a class="dropdown-item" id="on" href="index.jsp">Cerrar sesión</a></li>
                    </ul>
                </div>
            </div>
        </header>
